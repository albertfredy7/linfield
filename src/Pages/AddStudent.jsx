   ...
   const addStudentHandler = async () => {
      if (
         ...
         try {
            ...
            const { data } = await axios.post(
               'https://lms-backend-0hls.onrender.com/api/students/nios',
               requestData,
               config
            );
            if (data && data.name) {
            ...
            <div className=" h-full md:hidden flex flex-col">
               <div className="h-full overflow-y-auto px-5 flex flex-col gap-3">
                  <div className="flex flex-col pt-10">
                     <h1 className="text-xl font text-[#2740CD] font-bold">
                        Add Student
                     </h1>
                     <p className="text-[#333333]">
                        Enter the details of the student to register
                     </p>
                  </div>
                  <div className="pt-2">
                     <label
                     ...
                     <div className="grid grid-cols-4 gap-5">
                        <div className="col-span-2">
                           ...
                           <input
                              ...
                              placeholder="John Doe"
                              onChange={(e) =>
                                 setAdmCoordinator(e.target.value)
                              }
                              required
                           />
                        </div>

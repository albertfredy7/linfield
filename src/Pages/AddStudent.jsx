    ...
    <div className="bg-[#f0f0f0] h-screen w-screen overflow-hidden">
      <div className="h-full w-full  block md:grid md:grid-cols-7 lg:grid-cols-6 xl:grid-cols-11 2xl:grid-cols-6">
        ...
        <div className=" md:hidden flex flex-col gap-5 p-4">
          <div className='max-h-screen overflow-y-auto px-3'>
          ...
          <div className='col-span-9 space-y-8  '>
            ...
            <div className='grid grid-cols-12'>
              ...
              <div className='col-span-5 flex flex-col gap-3 3xl:gap-5  ps-12 px-3 row-span-5'>
                <div className=''>
                  <label for="name" class="block text-sm 3xl:text-md font-medium text-gray-900 ">Name</label>
                  <input type="text" id="name" class="bg-white border border-white text-gray-900 text-sm rounded-lg block w-full p-2 3xl:p-2.5" placeholder="John"
                    value={name}
                    onChange={(e) => setName(e.target.value)} required />
                </div>
                <div>
                  <label for="year" class="block text-sm font-medium text-gray-900 ">Course</label>
                  <Select options={courseOptions} styles={{
                    control: (baseStyles, state) => ({
                      ...baseStyles,
                      borderRadius: '.5rem',
                ...
                <div>
                  <label for="phoneNum" class="block text-sm font-medium text-gray-900 ">Phone Number</label>
                  <input type="text" id="phoneNum" class="bg-white border border-white text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="9876543210"
                    value={phoneNum}
                    onChange={(e) => setPhoneNum(e.target.value)} required />
                </div>
                <div>
                  <label for="email" class="block text-sm font-medium text-gray-900 ">Email</label>
                  <input type="email" id="email" class="bg-white border border-white text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="student@gmail.com" value={email} onChange={(e) => setEmail(e.target.value)} required />
                </div>
                <div>
                  <label for='admissionCorrdinator' class="block text-sm font-medium text-gray-900 ">Admission Coordinator</label>
                  <input type="text" id="admissionCorrdinator" class="bg-white border border-white text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="John Doe" value={admCoordinator} onChange={(e) => setAdmCoordinator(e.target.value)} required />
                </div>
              </div>
              ...
              <div className='col-span-4 flex flex-col gap-3 3xl:gap-5 px-4'>
                <div>
                  <label for="place" class="block text-sm font-medium text-gray-900 ">Place</label>
                ...
                <div>
                  <label for="year" class="block text-sm font-medium text-gray-900 ">Intake</label>
                  <Select options={intakeOptions} styles={{
                    control: (baseStyles, state) => ({
                      ...baseStyles,
                      borderRadius: '.5rem',
                ...
                <div>
                  <label for="parentNum" class="block text-sm font-medium text-gray-900 ">Parent's Phone Number</label>
                  <input type="text" id="parentNum" class="bg-white border border-white text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="9876543210" value={parentNum} onChange={(e) => setParentNum(e.target.value)} required />
                </div>
                <div>
                  <label for='confirmEmail' class="block text-sm font-medium text-gray-900 ">Confirm Email</label>
                  <input type="email" id="confirmEmail" class="bg-white border border-white text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="student@gmail.com" value={confirmEmail} onChange={(e) => setConfirmEmail(e.target.value)} required />
                </div>
                <div>
                  <label for='admissionFee' class="block text-sm font-medium text-gray-900 ">Admission Fee</label>
                  <input type="text" id="admissionFee" class="bg-white border border-white text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="1000" value={admissionFee} onChange={(e) => setAdmissionFee(e.target.value)} required />
                </div>
              </div>
              ...
              <div className='col-span-3 px-4 flex flex-col gap-3 3xl:gap-5'>
                <div>
                ...
                {course === 'Plustwo' && (
                  <div>
                    <label for="batch" class="block text-sm font-medium text-gray-900 ">Batch</label>
                    <Select options={batchOptions} styles={{
                      control: (baseStyles, state) => ({
                        ...baseStyles,
                        borderRadius: '.5rem',
                ...
                <div>
                  <label for="mode" class="block text-sm font-medium text-gray-900 ">Mode</label>
                  <Select options={modeOptions} styles={{
                    control: (baseStyles, state) => ({
                      ...baseStyles,
                      borderRadius: '.5rem',
                ...
                <div>
                  <label for="branch" class="block text-sm font-medium text-gray-900 ">Branch</label>
                  <Select options={branchOptions} styles={{
                    control: (baseStyles, state) => ({
                      ...baseStyles,
                      borderRadius: '.5rem',
            ...
            <div className='p-12 float-end w-1/4 ' >
              <Button
                buttonStyle={'bg-[#2740CD] text-white text-md lg:text-md font-medium p-3 px-6 rounded-xl w-full '}
                text={'Add Expense'}
              />

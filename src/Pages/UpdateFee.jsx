          ...
          <div className='grid grid-rows-12  h-screen'>
            <div className=' row-span-2   flex items-center justify-between px-5'>
              <div className=' px-5 flex flex-col'>
                ...
                <h1 className='text-[#333333] text-xs'>Update the fee of the student </h1>
              </div>
              <div className='  sm:pt-16'>
                <Button text={'Update'} buttonStyle={'bg-[#2740CD] text-white rounded-lg px-4 py-2 text-xs'} navigateUrl={'/feeUpdate'} />
              </div>
            </div>
            ...
            {student &&<div className='row-span-1 px-5 '>
              <DataCard
                type="admissions"
                title="Berlin"
                tailData="SSLC"
          ...
          <div className="col-span-6 h-full  px-12 grid grid-rows-9 3xl:grid-rows-12 overflow-hidden ">
            <div className="row-span-1 3xl:row-span-2 flex flex-col justify-center 3xl:justify-center px-4 ">
              <div className='flex justify-between'>
                ...
                <div className='flex justify-center items-center'>
                  <Button text={'Update Fee'} buttonStyle={'bg-[#2740CD] text-white rounded-lg px-4 py-2 text-md lg:text-xl 3xl:text-base'} navigateUrl={'/feeUpdate'} />
                </div>
              </div>
            </div>
            ...
            <div className="row-span-4 pt-10">
              ...
              <div className="overflow-y-auto h-full p-4">
                <div className="space-y-3">
                  <DataCard type="transactions" title="Admission Fee" subTitle={'23 Mar 2024'} midData={'CDHVHJGH122'} tailData="SSLC" />
                  <DataCard type="transactions" title="Admission Fee" subTitle={'23 Mar 2024'} midData={'CDHVHJGH122'} tailData="SSLC" />
                  <DataCard type="transactions" title="Admission Fee" subTitle={'23 Mar 2024'} midData={'CDHVHJGH122'} tailData="SSLC" />
                  <DataCard type="transactions" title="Admission Fee" subTitle={'23 Mar 2024'} midData={'CDHVHJGH122'} tailData="SSLC" />
                  <DataCard type="transactions" title="Admission Fee" subTitle={'23 Mar 2024'} midData={'CDHVHJGH122'} tailData="SSLC" />
          ...
          <div className="col-span-6 px-8 grid  3xl:grid-rows-10 xl:grid-rows-8  space-y-4 overflow-hidden pt-6 ">
            <div className='row-span-1 '>
              <div className='flex flex-col gap-0  px-5  '>
                <h1 className='text-3xl font-semibold'>Update Fee</h1>
                <h1 className='text-md font-medium text-[#333333]'>Update the fee of the student</h1>
              </div>
            </div>
            ...
            <div className='3xl:row-span-8 xl:row-span-6  h-full grid grid-rows-8'>
              ...
              <div className='3xl:row-span-4 xl:row-span-4 3xl:p-10 xl:p-5 '>
                {/* <div className="grid grid-cols-3 gap-5 h-full bg-white 3xl:p-10 xl:p-8 rounded-2xl">
                  <div className="w-full pr-2 pb-2">
                    <button type="button" className={`w-full ${student && student.feeDetails.admissionFeePaid ? 'text-green-500' : 'text-red-500'} border ${student && student.feeDetails.admissionFeePaid ? 'border-green-500' : 'border-red-500'} font-medium rounded-lg text-sm px-1 py-1`}>
                      <div><h1 className='3xl:text-lg xl:text-smg'>Admn Fee</h1></div>
                      <div><h1 className='3xl:text-lg xl:text-sm'></h1></div>
                    </button>
                  </div>
                  <div className="w-full pr-2 pb-2">
                    <button type="button" className={`w-full ${student && student.feeDetails.registrationFeePaid ? 'text-green-500' : 'text-red-500'}  border ${student && student.feeDetails.registrationFeePaid ? 'border-green-500' : 'border-red-500'} font-medium rounded-lg text-sm px-1 py-1`}>
                      <div><h1 className=' 3xl:text-lg xl:text-sm'>Reg Fee</h1></div>
                      <div><h1 className='3xl:text-lg xl:text-sm'></h1></div>
                    </button>
                  </div>
                  <div className="w-full me-2 mb-2">
                    <button type="button" className={`w-full ${student && student.feeDetails.examFeePaid ? 'text-green-500' : 'text-red-500'} border ${student && student.feeDetails.examFeePaid ? 'border-green-500' : 'border-red-500'} font-medium rounded-lg text-sm px-1 py-1`}>
                      <div><h1 className='3xl:text-lg xl:text-sm'>Exam Fee</h1></div>
                      <div><h1 className='3xl:text-lg xl:text-sm'></h1></div>
                    </button>
                  </div>
                  <div className="w-full me-2 mb-2">
                    <button type="button" className={`w-full ${student && student.feeDetails.installments[0].isPaid ? 'text-green-500' : 'text-red-500'} border ${student && student.feeDetails.installments[0].isPaid ? 'border-green-500' : 'border-red-500'} font-medium rounded-lg text-sm px-1 py-1`}>
                      <div><h1 className='3xl:text-lg xl:text-sm'>First Term</h1></div>
                      <div><h1 className='3xl:text-lg xl:text-sm'></h1></div>
                    </button>
                  ...
                  <div className="w-full me-2 mb-2">
                    <button type="button" className={`w-full ${student && student.feeDetails.installments[1].isPaid ? 'text-green-500' : 'text-red-500'} border ${student && student.feeDetails.installments[1].isPaid ? 'border-green-500' : 'border-red-500'} font-medium rounded-lg text-sm px-1 py-1`}>
                      <div><h1 className='3xl:text-lg xl:text-sm'>Second Term</h1></div>
                      <div><h1 className='3xl:text-lg xl:text-sm'></h1></div>
                    </button>
                  ...
                  <div className="w-full me-2 mb-2">
                    <button type="button" className={`w-full ${student && student.feeDetails.installments[2].isPaid ? 'text-green-500' : 'text-red-500'} border ${student && student.feeDetails.installments[2].isPaid ? 'border-green-500' : 'border-red-500'} font-medium rounded-lg text-sm px-1 py-1`}>
                      <div><h1 className='3xl:text-lg xl:text-sm'>Third Term</h1></div>
                      <div><h1 className='3xl:text-lg xl:text-sm'></h1></div>
                    </button>
              ...
              <div className='3xl:row-span-4 xl:row-span-4 overflow-hidden '>
                <h1 className='text-lg font-semibold ps-5 pb-2 pt-2'>Recent Transactions </h1>
            ...
            <div className='row-span-10  3xl:row-span-9  p-8 '>
              <div className='bg-white h-full grid grid-rows-6  rounded-2xl p-5 '>
                <div className='flex flex-col p-5 row-span-1 '>
                  <h1 className='xl:text-lg 3xl:text-3xl font-semibold'>Update Fee</h1>
                  <h1 className='xl:text-sm 3xl:text-lg font-base text-[#333333]'>Update the fee of the student</h1>
                </div>
                
                <div className=' xl:row-span-5 3xl:row-span-4 grid xl:grid-rows-5 3xl:grid-rows-5 2xl:gap-1 xl:gap-5  px-3 xl:pt-3'>
                  <div class=" row-span-1">
                    <label for="feeType" class="block text-sm 2xl:text-sm xl:text-xs font-medium text-gray-900 ">Select payment type</label>
                    ...
                    }} className="border border-gray-200 rounded bg-[#f0f0f0] 2xl:text-sm xl:text-xs text-gray-600" closeMenuOnSelect={true} isSearchable={false} onChange={(e) => setFeeType(e.value)} name="feeType" controlShouldRenderValue={feeType ? true : feeType === false ? true : false} />
                  </div>
                  <div class={` row-span-1`}>
                    <label for="paymentType" class="block 2xl:text-sm xl:text-xs xl: font-medium text-gray-900 ">Select fee type</label>
                    ...
                    }} className="border border-gray-200 rounded 2xl:text-sm xl:text-xs" closeMenuOnSelect={true} isSearchable={false} name="paymentType" onChange={(e) => setPaymentType(e.value)} controlShouldRenderValue={paymentType ? true : paymentType === false ? true : false} />
                  </div>

                  <div class="row-span-1">
                    <label for="amount" class="block text-sm 2xl:text-sm xl:text-xs font-medium text-gray-900 ">Amount</label>
                    <input type="text" id="amount" class="bg-[#f0f0f0] text-gray-600 border border-gray-200   text-sm 2xl:text-sm xl:text-xs rounded-lg block w-full p-2.5 focus:outline-blue-400" placeholder="1000"
                      value={amount}
                      onChange={(e) => setAmount(e.target.value)} required />
                  </div>
                  <div class="row-span-1">
                    <label for="utrNo" class="block text-sm 2xl:text-sm xl:text-xs font-medium text-gray-900 ">Enter the UTR number</label>
                    <input type="text" id="UtrNo" class="bg-[#f0f0f0] 2xl:text-sm xl:text-xs text-gray-600 border border-gray-200   text-sm rounded-lg block w-full p-2.5 focus:outline-blue-400" placeholder="CHJSU2UHBSA"
                      value={utrNumber}
                      onChange={(e) => setUtrNumber(e.target.value)} required />
                  </div>
                  <div className='row-span-1  flex items-end pb-5 '>
                    <Button text={'Update Fee'} buttonStyle={'bg-[#2740CD] text-white rounded-lg  flex items-center justify-center px-2 py-2 text-md lg:text-xl xl:text-sm 2xl:text-md 3xl:text-base  w-full'} />
                  </div>
                </div>
              </div>
            </div>

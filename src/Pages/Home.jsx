   ...
   useEffect(() => {
      ...
      if (!teacherInfo) {
         ...
         const getRevenue = async () => {
            ...
            // const { data } = await axios.get(
            //    'http:127.0.0.1:5000/api/transactions/totalRevenue'
            // );

            const { data } = await axios.get(
               'https://lms-backend-0hls.onrender.com/api/transactions/totalRevenue'
            );
         ...
         const getAdmissionsCount = async () => {
            ...
            // const { data } = await axios.get(
            //    'http://127.0.0.1:5000/api/students/totalAdmissions'
            // );

            const { data } = await axios.get(
               'https://lms-backend-0hls.onrender.com/api/students/totalAdmissions'
            );
         ...
         const getExpense = async () => {
            // const { data } = await axios.get(
            //    'http://127.0.0.1:5000/api/expense/totalExpense'
            // );

            const { data } = await axios.get(
               'https://lms-backend-0hls.onrender.com/api/expense/totalExpense'
            );
            setTotalExpense(
         ...
         const getRecentTransactions = async () => {
            // const { data } = await axios.get(
            //    'http://127.0.0.1:5000/api/transactions/recentTransactions'
            // );

            const { data } = await axios.get(
               'https://lms-backend-0hls.onrender.com/api/transactions/recentTransactions'
            );
         ...
         const getRecentAdmissions = async () => {
            ...
            // const { data } = await axios.get(
            //    'http://127.0.0.1:5000/api/students/recentAdmissions'
            // );

            const { data } = await axios.get(
               'https://lms-backend-0hls.onrender.com/api/students/recentAdmissions'
            );
               ...
               <div className="flex flex-col h-screen">
                  ...
                  <div className="overflow-y-auto h-full ">
                     ...
                     <div className="px-4 pt-5 ">
                        <h4 className="text-base text-gray-500 md:text-lg lg:text-3xl">
                           Recent transactions
                        </h4>

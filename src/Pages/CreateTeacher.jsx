...
function CreateTeacher() {
   ...
   const fetchTeachersData = async () => {
      ...
      // const { data } = await axios.get(
      //   'http://127.0.0.1:5000/api/teachers/showAll'
      // );

      const { data } = await axios.get(
         'https://lms-backend-0hls.onrender.com/api/teachers/showAll'
      );
      if (data) {
   ...
   const teacherSubmitHandler = async () => {
      try {
         ...
         //   requestData,
         //   config
         // ); https://6m3b89dl-5000.inc1.devtunnels.ms/
            ...
            <div className="block md:hidden  ">
               <div className="flex flex-col h-screen">
                  ...
                  <div className="pt-5 px-1">
                     <MobileOverviewCard
                        title={'Total Staff'}
                        subtitle={
                           teachersData.length > 0 ? teachersData.length : '0'
                        }
                     />
                  </div>
              ...
              <DataCard type="admissions" title="John" tailData="Teacher" /> */}
                     {teachersData.length > 0 ? (
                        ...
                        <div className="text-center text-lg  overflow-y-hidden flex flex-col justify-center items-center">
                           <img

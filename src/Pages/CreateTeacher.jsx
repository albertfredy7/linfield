        ...
        <div className="hidden md:grid md:grid-cols-7 lg:grid-cols-7 xl:hidden p-4 w-screen h-screen">
          ...
          <div className="col-span-6 h-full  px-12 grid grid-rows-9 3xl:grid-rows-12 overflow-hidden ">
            ...
            <div className="row-span-1   ">
              <OverviewCard title={'Total Staff'} number={'200'} />
            </div>

            <div className="row-span-1 flex justify-between  gap-5 pt-5 lg:pt-8 px-5 items-center">
              <div>
                <h2 className='text-gray-500 font-semibold lg:text-2xl'>Current Staff</h2>
              </div>
              <Button
                text="Create"
        ...
        <div className="hidden xl:grid xl:grid-cols-11 p-4 w-screen h-screen">
          ...
          <div className="col-span-3 h-full  overflow-hidden flex items-center ">
            ...
            <div className="pt-10 px-5 py-2 w-full">
              <div className=" h-full flex flex-col bg-white p-12 rounded-xl w-full">
                <div className="">
                ...
                <div className="  pt-8 flex flex-col gap-3">
                  ...
                  <div>
                    ...
                    <input type="text" id="name" placeholder="Enter name" className="bg-[#f0f0f0] text-gray-600 bg text-sm 3xl:text-lg  rounded-md block w-full p-2 3xl:p-3 md:p-4 xl:p-2"
                    onChange={
                      (e) => {
                  ...
                  <div>
                    ...
                    <input type="text" id="contactNo" placeholder="Enter contact number" className="bg-[#f0f0f0] text-gray-600 bg text-sm 3xl:text-lg  rounded-md block w-full p-2 3xl:p-3 md:p-4 xl:p-2"
                    onChange={
                      (e) => {
                  ...
                  <div>
                    ...
                    <input type="email" id="email" placeholder="Enter email" className="bg-[#f0f0f0] text-gray-600 bg text-sm 3xl:text-lg  rounded-md block w-full p-2 3xl:p-3 md:p-4 xl:p-2" 
                    onChange={
                      (e) => {
                  ...
                  <div>
                    ...
                    <input type="password" id="password" placeholder="Enter password" className="bg-[#f0f0f0] text-gray-600 bg text-sm 3xl:text-lg  rounded-md block w-full p-2 3xl:p-3 md:p-4 xl:p-2"
                    onChange={
                      (e) => {

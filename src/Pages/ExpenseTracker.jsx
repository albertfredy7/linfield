...
function ExpenseTracker() {
   ...
   const options = [
      ...
      { value: 'Miscallaneous', label: 'Miscallaneous' },
   ];
   ...
   const fetchData = async () => {
      if (
         ...
         const { data } = await axios.get(
            `https://lms-backend-0hls.onrender.com/api/expense?duration=${selectedDuration}`
         );
         ...
         const { data } = await axios.get(
            `https://lms-backend-0hls.onrender.com/api/expense?duration=custom&start_date=${selectedDuration}&end_date=${selectedDuration}`
         );
                        ...
                        <div className=" w-full h-full overflow-y-auto">
                           <div className="space-y-3">
                              {expenseData.length > 0 ? (
                                 ...
                                 <div className="text-center text-base font-semibold overflow-y-hidden flex flex-col justify-end items-center bg-[#f0f0f0]">
                                    <img
                                       src="https://blog.vantagecircle.com/content/images/2021/08/open-to-learning-engaged-employees-1.gif"
                                       className="mix-blend-multiply w-4/6"
                                       alt=""

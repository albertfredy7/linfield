    ...
    return (
        <div className="lg:grid lg:grid-cols-12 xl:grid xl:grid-cols-12 lg:bg-[#f0f0f0] ">
            ...
            <div className="col-span-9 ">
                ...
                <div className='bg-[#f0f0f0] p-8 h-screen'>
                    <div className="bg-white h-full flex flex-col rounded-xl p-4">
                        <div className='flex justify-center items-center flex-col'>
                            <img src={logo} alt="logo" className='lg:w-40 w-[50%] mt-10 mb-4' />
                        </div>
                                ...
                                <form className='form-controls w-full lg:mx-[30%]' onSubmit={handleSubmit}>
                                    <div className='flex flex-col items-center gap-7 mt-10'>
                                        <div className='lg:w-full w-full mx-5 text-lg'>
                                            ...
                                            <input type="text" placeholder='Email' className='mt-2 text-lg bg-[#f0f0f0] border border-white text-gray-900 rounded-lg block sm:w-full md:w-3/4 lg:w-full p-2.5 w-full' onChange={(e) => setEmail(e.target.value)} />
                                        </div>
                                        <div className='lg:w-full w-full mx-5 text-lg'>
                                            <label htmlFor="password">Password</label>
                                            <input type="text" placeholder='Enter the password' className='mt-2 bg-[#f0f0f0] text-lg border border-white text-gray-900 rounded-lg block sm:w-full md:w-3/4 lg:w-full w-full p-2.5' onChange={(e) => setPassword(e.target.value)} />
                                        </div>

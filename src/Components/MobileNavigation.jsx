        ...
        <div className=' bottom-0 bg-white shadow-lg w-full rounded-t-3xl p-5'> 
            <div className='flex gap-5 items-center justify-center'>
                ...
                <div className='flex flex-col items-center' onClick={() => navigate('/insights')}>
                    <InsightsIcon fontSize='medium' style={{ color: location.pathname === '/insights' ? '#2740CD' : '#717171' }} />
                    <p className='text-nowrap text-sm sm:text-md' style={{ color: location.pathname === '/insights' ? '#2740CD' : '#717171' }}>Insights</p>
                </div>
                <div className='flex flex-col items-center' onClick={() => handleOpenModal()}>
                    <BlurOnIcon fontSize='medium' style={{ color: location.pathname === '/more' ? '#2740CD' : '#717171' }} />
